// Purpose: derive the photon+jet or Z+jet Data/MC response inputs used by the active
...
void deriveL3(
  ...
  if (useabs) {
    ...
    mc3d[etabins[i].c_str()] = (TProfile3D *)inFileMC->Get(Form(
        "hibin_-1.0_0.0/eta_-5.2_5.2/%s_balance3Dabseta", histPrefix.Data()));
    data3d[etabins[i].c_str()] = (TProfile3D *)inFileDT->Get(Form(
        "hibin_-1.0_0.0/eta_-5.2_5.2/%s_balance3Dabseta", histPrefix.Data()));
    mc3dJetPt[etabins[i].c_str()] = (TProfile3D *)inFileMC->Get(Form(
        "hibin_-1.0_0.0/eta_-5.2_5.2/%s_balance3Dabseta_jetpt", histPrefix.Data()));
    data3dJetPt[etabins[i].c_str()] = (TProfile3D *)inFileDT->Get(Form(
        "hibin_-1.0_0.0/eta_-5.2_5.2/%s_balance3Dabseta_jetpt", histPrefix.Data()));
    counts_mc3d[etabins[i].c_str()] = (TH3D *)inFileMC->Get(Form(
        "hibin_-1.0_0.0/eta_-5.2_5.2/%s_balance3Dabseta_counts", histPrefix.Data()));
    counts_data3d[etabins[i].c_str()] = (TH3D *)inFileDT->Get(Form(
        "hibin_-1.0_0.0/eta_-5.2_5.2/%s_balance3Dabseta_counts", histPrefix.Data()));
  } else if (usewideabs) {
    vseta_mc = new TH1D("vseta_mc", "MC balance; |#eta_{jet}|; balance",
    ...
    mc3d[etabins[i].c_str()] = (TProfile3D *)inFileMC->Get(Form(
        "hibin_-1.0_0.0/eta_-5.2_5.2/%s_balance3Dabsetawide", histPrefix.Data()));
    data3d[etabins[i].c_str()] = (TProfile3D *)inFileDT->Get(Form(
        "hibin_-1.0_0.0/eta_-5.2_5.2/%s_balance3Dabsetawide", histPrefix.Data()));
    mc3dJetPt[etabins[i].c_str()] = (TProfile3D *)inFileMC->Get(Form(
        "hibin_-1.0_0.0/eta_-5.2_5.2/%s_balance3Dabsetawide_jetpt", histPrefix.Data()));
    data3dJetPt[etabins[i].c_str()] = (TProfile3D *)inFileDT->Get(Form(
        "hibin_-1.0_0.0/eta_-5.2_5.2/%s_balance3Dabsetawide_jetpt", histPrefix.Data()));
    counts_mc3d[etabins[i].c_str()] = (TH3D *)inFileMC->Get(Form(
        "hibin_-1.0_0.0/eta_-5.2_5.2/%s_balance3Dabsetawide_counts", histPrefix.Data()));
    counts_data3d[etabins[i].c_str()] = (TH3D *)inFileDT->Get(Form(
        "hibin_-1.0_0.0/eta_-5.2_5.2/%s_balance3Dabsetawide_counts", histPrefix.Data()));
  } else {
    vseta_mc = new TH1D("vseta_mc", "MC balance; #eta_{jet}; balance",
    ...
    mc3d[etabins[i].c_str()] = (TProfile3D *)inFileMC->Get(Form(
        "hibin_-1.0_0.0/eta_-5.2_5.2/%s_balance3D", histPrefix.Data()));
    data3d[etabins[i].c_str()] = (TProfile3D *)inFileDT->Get(Form(
        "hibin_-1.0_0.0/eta_-5.2_5.2/%s_balance3D", histPrefix.Data()));
    mc3dJetPt[etabins[i].c_str()] = (TProfile3D *)inFileMC->Get(Form(
        "hibin_-1.0_0.0/eta_-5.2_5.2/%s_balance3D_jetpt", histPrefix.Data()));
    data3dJetPt[etabins[i].c_str()] = (TProfile3D *)inFileDT->Get(Form(
        "hibin_-1.0_0.0/eta_-5.2_5.2/%s_balance3D_jetpt", histPrefix.Data()));
    counts_mc3d[etabins[i].c_str()] = (TH3D *)inFileMC->Get(Form(
        "hibin_-1.0_0.0/eta_-5.2_5.2/%s_balance3D_counts", histPrefix.Data()));
    counts_data3d[etabins[i].c_str()] = (TH3D *)inFileDT->Get(Form(
        "hibin_-1.0_0.0/eta_-5.2_5.2/%s_balance3D_counts", histPrefix.Data()));
  }
