...
void dofits_L3(
    TString inFileL3Derived = "L3_derived.root",
    TString sampleTypesCSV = "photonjet", TString inputPtRangesCSV = "",
    string outfilename = "L3Res_photonjet", string runLabel = "2024ppRef",
    string lumiLabel = "pp 480.4 pb^{-1}", int refAlphaBin = 5,
    double fitAlphaMin = 0.0, double fitAlphaMax = 0.4,
  ...
  L3Res(inFileL3Derived, sampleTypesCSV, inputPtRangesCSV, outfilename,
        runLabel, lumiLabel, refAlphaBin, fitAlphaMin, fitAlphaMax,
        normalizedBaseDir);
