...
string scaleFactorFile =
    "jecfiles/Summer23Prompt23_RunCv4_JRV1m_MC_SF_AK4PFPuppi.txt";

string jersfuncertFile =
    "jecfiles/Summer23Prompt23_RunCv4_JRV1m_MC_SFUncertainty_AK4PFPuppi.txt";
float jersfuncscale = 0.03; // Scale pp uncertainty up/down in a similar manner
                            // as in 2023 JEC uncertainties
...
// float etaedges[] = {-5.2, -3.9, -2.6, -1.3, 0, 1.3, 2.6, 3.9, 5.2,
// -5.2, 5.2};
