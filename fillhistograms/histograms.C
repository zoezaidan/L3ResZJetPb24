...
void histograms::initializePointers() {
  ...
  HLT_Z_ptav = nullptr;
  zjet_dphi = nullptr;
  zjet_balance = nullptr;
  zjet_ptavg = nullptr;
  zjet_alpha = nullptr;
  zjet_balance_a01 = nullptr;
  zjet_balance_a02 = nullptr;
  zjet_balance_a03 = nullptr;
  zjet_balance_a04 = nullptr;
  zjet_balance_a05 = nullptr;
  zjet_balance_a06 = nullptr;
  zjet_balance2D_a01 = nullptr;
  zjet_balance2D_a02 = nullptr;
  zjet_balance2D_a03 = nullptr;
  zjet_balance2D_a04 = nullptr;
  zjet_balance2D_a05 = nullptr;
  zjet_balance2D_a06 = nullptr;
  zjet_balance3D = nullptr;
  zjet_balance3Dwide = nullptr;
  zjet_balance3Dnarrow = nullptr;
  zjet_balance3Dabseta = nullptr;
  zjet_balance3Dabsetawide = nullptr;
  zjet_balance3Dabsetanarrow = nullptr;
  zjet_balance3D_counts = nullptr;
  zjet_balance3Dwide_counts = nullptr;
  zjet_balance3Dnarrow_counts = nullptr;
  zjet_balance3Dabseta_counts = nullptr;
  zjet_balance3Dabsetawide_counts = nullptr;
  zjet_balance3Dabsetanarrow_counts = nullptr;
  ...
  absasymmdist3D_a45 = nullptr;
    absasymmdist3D_gen_a10 = nullptr;
    absasymmdist3D_gen_a15 = nullptr;
    absasymmdist3D_gen_a20 = nullptr;
    absasymmdist3D_gen_a25 = nullptr;
    absasymmdist3D_gen_a30 = nullptr;
    absasymmdist3D_gen_a35 = nullptr;
    absasymmdist3D_gen_a40 = nullptr;
    absasymmdist3D_gen_a45 = nullptr;
...
histograms::histograms(TDirectory *dir, float etamin, float etamax,
  ...
  bool createPhotonJet =
    ...
    bool createZJet = (isZJetAnalysisType(type) || type == AnalysisType::ALL);
  ...
  if (ismc) {
    ...
    if (createPhotonJet) {
      genphoton_pt = new TH1D(
          "gen photon pT", "gen photon p_{T}; gen photon p_{T};", 100, 0, 500);
      genphoton_eta = new TH1D(
          "gen photon eta", "gen photon #eta; gen photon #eta;", 50, -2.5, 2.5);
      genphoton_phi =
          new TH1D("gen photon phi", "gen photon #phi; gen photon #phi;", nphis,
                   phirange);
    ...
    if (createZJet) {
      ...
      genz_eta =
          new TH1D("gen z eta", "gen Z #eta; gen Z #eta;", 50, -2.5, 2.5);
      genz_phi =
          new TH1D("gen z phi", "gen Z #phi; gen Z #phi;", nphis, phirange);
      zresponse = new TProfile("z response", "", 100, 0, 500);
      z_ptres =
          new TH1D("z pT res", "Z p_{T}; (p_{T,reco}-p_{T,gen})/p_{T,gen};", 40,
                   -0.5, 0.5);
    }
  }
  ...
  if (createZJet) {
    ...
    // 1D profiles
    zjet_balance_a01 = new TProfile("zjet_balance_a01", "Balance (#alpha<0.1)",
                                    nptforjec, &ptforjec[0]);
    zjet_balance_a02 = new TProfile("zjet_balance_a02", "Balance (#alpha<0.2)",
                                    nptforjec, &ptforjec[0]);
    zjet_balance_a03 = new TProfile("zjet_balance_a03", "Balance (#alpha<0.3)",
                                    nptforjec, &ptforjec[0]);
    zjet_balance_a04 = new TProfile("zjet_balance_a04", "Balance (#alpha<0.4)",
                                    nptforjec, &ptforjec[0]);
    zjet_balance_a05 = new TProfile("zjet_balance_a05", "Balance (#alpha<0.5)",
                                    nptforjec, &ptforjec[0]);
    zjet_balance_a06 = new TProfile("zjet_balance_a06", "Balance (#alpha<0.6)",
                                    nptforjec, &ptforjec[0]);

    // 2D profiles
    zjet_balance2D_a01 =
        new TProfile2D("zjet_balance2D_a01", "Balance (#alpha<0.1)", nptforjec,
                       &ptforjec[0], nwetas, &wetarange[0]);
    zjet_balance2D_a02 =
        new TProfile2D("zjet_balance2D_a02", "Balance (#alpha<0.2)", nptforjec,
                       &ptforjec[0], nwetas, &wetarange[0]);
    zjet_balance2D_a03 =
        new TProfile2D("zjet_balance2D_a03", "Balance (#alpha<0.3)", nptforjec,
                       &ptforjec[0], nwetas, &wetarange[0]);
    zjet_balance2D_a04 =
        new TProfile2D("zjet_balance2D_a04", "Balance (#alpha<0.4)", nptforjec,
                       &ptforjec[0], nwetas, &wetarange[0]);
    zjet_balance2D_a05 =
        new TProfile2D("zjet_balance2D_a05", "Balance (#alpha<0.5)", nptforjec,
                       &ptforjec[0], nwetas, &wetarange[0]);
    zjet_balance2D_a06 =
        new TProfile2D("zjet_balance2D_a06", "Balance (#alpha<0.6)", nptforjec,
                       &ptforjec[0], nwetas, &wetarange[0]);
    ...
    // 3D profiles (only for wide eta bin)
    if ((this->etamin - this->etamax) < -10) {
      zjet_balance3D = new TProfile3D(
          "zjet_balance3D", "Balance vs p_{T,avg}, #eta_{jet}, #alpha",
          nptforjec, &ptforjec[0], nwetas, &wetarange[0], nalphavalues,
          &alphavalues[0]);
      zjet_balance3Dwide = new TProfile3D(
          "zjet_balance3Dwide", "Balance (wide #eta bins)", nptforjec,
          &ptforjec[0], nwetas, &wetarange[0], nalphavalues, &alphavalues[0]);
      zjet_balance3Dnarrow = new TProfile3D(
          "zjet_balance3Dnarrow", "Balance (narrow #eta bins)", nptforjec,
          &ptforjec[0], netas, &etarange[0], nalphavalues, &alphavalues[0]);
      zjet_balance3Dabseta = new TProfile3D(
          "zjet_balance3Dabseta", "Balance vs p_{T,avg}, |#eta_{jet}|, #alpha",
          nptforjec, &ptforjec[0], nwabsetas, &wabsetarange[0], nalphavalues,
          &alphavalues[0]);
      zjet_balance3Dabsetawide = new TProfile3D(
          "zjet_balance3Dabsetawide", "Balance (wide |#eta| bins)", nptforjec,
          &ptforjec[0], ndwabsetas, &dwabsetarange[0], nalphavalues,
          &alphavalues[0]);
      zjet_balance3Dabsetanarrow = new TProfile3D(
          "zjet_balance3Dabsetanarrow", "Balance (narrow |#eta| bins)",
          nptforjec, &ptforjec[0], nabsetas, &absetarange[0], nalphavalues,
          &alphavalues[0]);
      zjet_balance3D_counts = new TH3D(
          "zjet_balance3D_counts", "Entries vs p_{T,avg}, #eta_{jet}, #alpha",
          nptforjec, &ptforjec[0], nwetas, &wetarange[0], nalphavalues,
          &alphavalues[0]);
      zjet_balance3Dwide_counts = new TH3D(
          "zjet_balance3Dwide_counts", "Entries (wide #eta bins)", nptforjec,
          &ptforjec[0], nwetas, &wetarange[0], nalphavalues, &alphavalues[0]);
      zjet_balance3Dnarrow_counts =
          new TH3D("zjet_balance3Dnarrow_counts", "Entries (narrow #eta bins)",
                   nptforjec, &ptforjec[0], netas, &etarange[0], nalphavalues,
                   &alphavalues[0]);
      zjet_balance3Dabseta_counts = new TH3D(
          "zjet_balance3Dabseta_counts",
          "Entries vs p_{T,avg}, |#eta_{jet}|, #alpha", nptforjec, &ptforjec[0],
          nwabsetas, &wabsetarange[0], nalphavalues, &alphavalues[0]);
      zjet_balance3Dabsetawide_counts = new TH3D(
          "zjet_balance3Dabsetawide_counts", "Entries (wide |#eta| bins)",
          nptforjec, &ptforjec[0], ndwabsetas, &dwabsetarange[0], nalphavalues,
          &alphavalues[0]);
      zjet_balance3Dabsetanarrow_counts =
          new TH3D("zjet_balance3Dabsetanarrow_counts",
                   "Entries (narrow |#eta| bins)", nptforjec, &ptforjec[0],
                   nabsetas, &absetarange[0], nalphavalues, &alphavalues[0]);
